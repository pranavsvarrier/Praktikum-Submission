...
def train_eegnet_64_16_20(emotion='valence'):
    print(f"TRAINING EEGNET - 64-16-20 SPLIT - {emotion.upper()}")
    ...
    # STRATIFIED TRIAL WISE SPLIT
    print("Creating STRATIFIED Subject Based 64-16-20 split...")
    ...
    trainer.fit(
        ...
        val_loader,
        max_epochs=50,
        default_root_dir=f'./checkpoints_eegnet_SubjectWise_{emotion}_64_16_20',
        callbacks=[
    ...
    results_file = f'results/eegnet_{emotion}_trial_level_64_16_20.txt'
    
    with open(results_file, 'w', encoding='utf-8') as f:
        f.write(f"EEGNet Results (Trial-Level 64-16-20 Split) - {emotion.upper()}\n")
...
if __name__ == '__main__':
    EMOTION = 'dominance'  # Change to 'arousal' or 'dominance'
    train_eegnet_64_16_20(emotion=EMOTION)